Creates a window that has buttons to show a latin word (one of the top 1000 most frequent), its principal parts, and its meaning. If you click "Don't show this word", once you save that word will not be shown again.

Parses the words directly from Dickinson's XML file, so some words have unusual formats.

Run this with Python 3 from Python.org. Main.py has to be in the same location as save.txt and list.txt
